...
urlpatterns = patterns('',
   ...
   #url(r'^enterprise/project/delete/','alpha.views.delete_project'),
   ...
   url(r'^enterprise/edit-challenge/','alpha.views.edit_project'),
   url(r'^enterprise/view-submitted-challenge/','alpha.views.view_submitted_project'),
   url(r'^enterprise/view-challenge-submission/','alpha.views.view_challenge_submission'),
   url(r'^enterprise/save-challenge-feedback/','alpha.views.challenge_feedback'),
   ...
   url(r'^enterprise/view-assigned-assessment/','alpha.views.view_assigned_assessment'),
   ...
   url(r'^tested/', 'alpha.views.tested'),
   url(r'^multi-file-upload/', 'alpha.views.multiFileuploader'),
   url(r'^multifile-delete/(\d+)/$', 'alpha.views.multiFileDelete'),
   url(r'^invite-friend/', 'alpha.views.signup_invite'),
   url(r'^invite-assign-admin/','alpha.views.invite_RequestAdminDisplay'),
   url(r'^authorize_invite/','alpha.views.authorize_Invites'),
   url(r'^signup-verify/','alpha.views.check_validUser'),
   url(r'^view-strength/','alpha.views.view_strength'),
   url(r'^admin-view-strength/','alpha.views.view_strengthAdmin'),
   url(r'^add-strength/','alpha.views.add_strength'),
   url(r'^delete-strength/','alpha.views.delete_strength'),
   url(r'^view-hire-manager/','alpha.views.view_hire_manager'),
   url(r'^create-requisition/','alpha.views.create_requisition'),
   url(r'^edit-requisition/','alpha.views.update_requisition'),
   url(r'^view-strengthcode/','alpha.views.view_strengthCode'),
   url(r'^create-strengthCode/','alpha.views.create_strengthCode'),
   url(r'^delete-strengthCode/','alpha.views.delete_strengthCode'),
   url(r'^request-strengthCode/','alpha.views.request_strengthCode'),
   url(r'^enterprise/view-verification/','alpha.views.enterprise_verification'),
   url(r'^enterprise/create-verification/','alpha.views.create_enterprise_verification'),
   url(r'^enterprise/show-student-profile/','alpha.views.show_student_profile'),
   url(r'^student/add-goals/','alpha.views.add_goals'),
   url(r'^student/update-goals/','alpha.views.update_goals'),
   url(r'^student/delete-goals/','alpha.views.delete_goals'),
   url(r'^student/add-buzzCategory/','alpha.views.create_BuzzCategory'),
   url(r'^candidate/add-buzz/','alpha.views.create_Buzz'),
   ...
   url(r'^enterprise/edit-goalStatement/','alpha.views.edit_goalStatement_enterprise'),  
